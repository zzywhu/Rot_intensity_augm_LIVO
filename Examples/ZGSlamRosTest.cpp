...
void publishLoopInfos()
{
    ...
    if (_sys->loopCloser()->loopCount()!=_loopCount)
    {
        ...
        markerEdge.color.r = 0.0; markerEdge.color.g = 1.0; markerEdge.color.b = 0;
...
//        _lastIMUSeqID=msgIn->header.seq;
    ...
    msg->header = msgIn->header.stamp.toSec() -
                  _sys->_timediffImuWrtLidar - _sys->config()._timeLagIMUWtrLidar;
...
void setParams()
{
    ...
    LoopCloser::mutableConfig()._poseGraphOptimizationMethod="gtsam";
    ...
    LoopCloser::mutableConfig()._isFramewisePGO = false;
