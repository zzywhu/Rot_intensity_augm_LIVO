...
typename pcl::PointCloud<PointType>::ConstPtr readPointCloudTxt(const std::string &filename)
{
    typename pcl::PointCloud<PointType>::Ptr pl_ptr(new pcl::PointCloud<PointType>());
