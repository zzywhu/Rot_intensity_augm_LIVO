...
class LsqRegistration : public pcl::Registration<PointSource, PointTarget, double> {
public:
  using Scalar = double;
...
public:
  ...
  double evaluateCost(const Eigen::Matrix4d& relative_pose, Eigen::Matrix<double, 6, 6>* H = nullptr, Eigen::Matrix<double, 6, 1>* b = nullptr);
