...
/// information and color.
    ...
    public:
        ...
        inline const VectorType &rgb() const
        { return rgb_; }
...
/// parameters are more likely to keep fixed and they can be set via the setters.
    struct Match4PCSOptions
    {
        ...
        inline Scalar getTerminateThreshold() const
        { return terminate_threshold; }

        inline Scalar getOverlapEstimation() const
        { return overlap_estimation; }
