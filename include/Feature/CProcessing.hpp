...
#define CPROCESSING_API __declspec(dllexport)
#else
#define CPROCESSING_API __declspec(dllimport)
#endif
#else
#define CPROCESSING_API
#endif
...
class CPROCESSING_API CProceesing : public CloudUtility<PointT>
{
public:
						 ...
						 typename pcl::PointCloud<PointT>::Ptr &corner_cloud) //KNN corner point extraction
	{
		...
		std::vector<int> pointIdxNKNSearch(K);		  //index in the order of the distance
