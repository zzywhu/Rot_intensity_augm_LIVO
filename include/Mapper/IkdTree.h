...
#define IKDTREE_API __declspec(dllexport)
#else
#define IKDTREE_API __declspec(dllimport)
#endif
#else
#define IKDTREE_API
#endif
...
public:
    ...
    PointVector Add_Points(PointVector &PointToAdd, bool downsample_on);
